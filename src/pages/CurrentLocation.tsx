    ...
    <>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className=''>
            <div className={`w-full mx-auto flex justify-center items-center absolute inset-0 transition-all duration-500 ease-in-out transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
              <div className={`rounded-2xl text-white bg-opacity-30 bg-black h-[50vh] w-[26rem] sm:w-[20rem] p-5 z-10 m-5 transition-all duration-500 ease-in-out transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
